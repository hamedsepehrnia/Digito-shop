...
- ✅ **ذکر منبع**: باید منبع اصلی را ذکر کنید

**محدودیت‌ها:**
- ❌ **استفاده تجاری**: استفاده تجاری از این مطالب مجاز نیست

برای جزئیات بیشتر، فایل [LICENSE](LICENSE) را مطالعه کنید یا به [صفحه رسمی لایسنس](https://creativecommons.org/licenses/by-nc/4.0/) مراجعه کنید.
